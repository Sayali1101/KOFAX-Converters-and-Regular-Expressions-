...
Default value changed: ignoreLoadErrors false -&gt; true</property>
        ...
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment" class="String">Loads the News Magazine website. Executing this step will show News Magazine in the Browser View.</property>
        <property name="enabled" idref="2"/>
      ...
      <object class="Transition" serializationversion="3" id="8">
        ...
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment" class="String">Extracts the article title into the title attribute of the article variable.
Execute this step and look in the variables view in the lower right corner to see the extracted text.</property>
        <property name="enabled" idref="2"/>
        <property name="changedProperties" class="java.util.HashSet">
          <element idref="6"/>
        </property>
      ...
      <object class="Transition" serializationversion="3" id="9">
        ...
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment" class="String">Extracts the preview of the article into the preview attribute of the article variable.</property>
        <property name="enabled" idref="2"/>
        <property name="changedProperties" class="java.util.HashSet">
          <element idref="6"/>
        </property>
      ...
      <object class="Transition" serializationversion="3" id="10">
        ...
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment" class="String">Returns the values in the article attribute.</property>
        <property name="enabled" idref="2"/>
        <property name="changedProperties" class="java.util.HashSet">
          <element idref="6"/>
        </property>
      ...
      <object class="SnippetStep" id="11">
        ...
        <snippetName class="String">LoadHelp2</snippetName>
        <snippetStepComment>
          <null/>
        </snippetStepComment>
      </object>
      <object class="Transition" serializationversion="3" id="12">
        <property name="name" class="String">CLICK HERE LAST</property>
        <property name="stepAction" class="DoNothing"/>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
