    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="6">
        ...
        <property name="stepAction" class="NewWindow" serializationversion="0">
          <property name="windowName" class="String">Window 2</property>
        </property>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
      ...
      <object class="Transition" serializationversion="3" id="8">
        <property name="name" class="String">CLICK HERE SECOND</property>
        <property name="stepAction" class="DoNothing"/>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
      ...
      <object class="SnippetStep" id="9">
        ...
        <snippetName class="String">LoadHelp3</snippetName>
        <snippetStepComment>
          <null/>
        </snippetStepComment>
      </object>
      <object class="Transition" serializationversion="3" id="10">
        <property name="name" class="String">CLICK HERE THIRD</property>
        <property name="stepAction" class="DoNothing"/>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
...
Default value changed: ignoreLoadErrors false -&gt; true</property>
      ...
      <object class="Transition" serializationversion="3" id="14">
        <property name="name" class="String">For Each Window</property>
