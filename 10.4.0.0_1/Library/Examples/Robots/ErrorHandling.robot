  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="7">
        ...
        <property name="stepAction" class="GenerateError">
          <property name="errorMessageExpression" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">Purposefully generated error.</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders" id="8"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment" class="String">Generates an error in order to showcase how default Error Handling works in Design Studio.</property>
        <property name="enabled" idref="1"/>
      ...
      <object class="Transition" serializationversion="3" id="9">
        <property name="name" class="String">This step can never be reached.</property>
        <property name="stepAction" class="DoNothing"/>
      ...
      <object class="Transition" serializationversion="3" id="11">
        ...
        <property name="comment" class="String">The robot continues execution even though this step generates an error. This is due to the Error Handling configured in this step.</property>
        <property name="enabled" idref="1"/>
        <property name="changedProperties" class="java.util.HashSet">
          <element idref="5"/>
        </property>
      ...
      <object class="Transition" serializationversion="3" id="12">
        <property name="name" class="String">This step is can be reached.</property>
        <property name="stepAction" class="DoNothing"/>
        <property name="elementFinders" class="ElementFinders"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
